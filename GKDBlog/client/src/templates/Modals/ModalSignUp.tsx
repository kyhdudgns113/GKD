...
export function ModalSignUp() {
  ...
  const onClickSignUp = useCallback(() => {
    signUp(userId, userName, password).then(result => {
      if (result) {
        closeModal()
      }
    })
  }, [userId, userName, password, signUp, closeModal])
    ...
    <Modal onClose={() => {}}>
      ...
      <div onKeyDown={onKeyDownModal} style={styleModal} tabIndex={0}>
        ...
        <div style={styleBtnRow}>
          <button style={styleBtn} onClick={onClickSignUp}>
            가입
          </button>
