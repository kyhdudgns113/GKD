export const [STATE_INIT, STATE_PRE_FLOP, STATE_FLOP, STATE_TURN, STATE_RIVER, STATE_FINISH] = [
  0, 1, 2, 3, 4, 5
]
...
export const [USER_LEAVE, USER_PLAYING, USER_ALL_IN, USER_FOLD] = [0, 1, 2, 3]
export const [BTN_CBF, BTN_CHIP, BTN_SIZE] = [0, 1, 2]
...
export const [ORANGE100, ORANGE200, ORANGE300] = ['#FFEDD5', '#FED7AA', '#FDBA74']
export const [ORANGE400, ORANGE500, ORANGE600] = ['#FB923C', '#F97316', '#EA580C']
