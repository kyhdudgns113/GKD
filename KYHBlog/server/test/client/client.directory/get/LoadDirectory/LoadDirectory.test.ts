...
export class LoadDirectoryFunction extends GKDTestBase {
  private WrongInput: WrongInput
  private SuccessCases: SuccessCases
...
if (require.main === module) {
  ...
  const testModule = new LoadDirectoryFunction(DEFAULT_REQUIRED_LOG_LEVEL) // __Test 대신에 모듈 이름 넣는다.
