...
/**
 * ClientAuthPort 의 logIn 함수를 테스트한다.
 *
 * ------
 *
 * 서브 테스트 모듈
 ...
 * 2. 성공 케이스
 */
export class LogInFunction extends GKDTestBase {
...
if (require.main === module) {
  ...
  const testModule = new LogInFunction(DEFAULT_REQUIRED_LOG_LEVEL) // __Test 대신에 모듈 이름 넣는다.
